...
//alert('in controller');
  ...
  $http({
  method:'POST',
  url:'http://server-employportal.1d35.starter-us-east-1.openshiftapps.com/login',
  data:login,
...
var signup={
  ...
  $http({
  method:'POST',
  url:'http://server-employportal.1d35.starter-us-east-1.openshiftapps.com/registerEmployee',
  data:signup,
  header:{'Content-Type':'application/json'}
  }).success(function (data, status, headers, config) {
...
//alert('in showemployee controller !!! READY TO fetch');
  ...
  $http({
  method:'GET',
  url:'http://server-employportal.1d35.starter-us-east-1.openshiftapps.com/employees',
...
$http({
  method:'DELETE',
  url:'http://server-employportal.1d35.starter-us-east-1.openshiftapps.com/delete/'+id
...
$http({
  method:'GET',
  url:'http://server-employportal.1d35.starter-us-east-1.openshiftapps.com/getEmployeeInfo/'+uid
...
var employeeupdatedata={
  ...
  $http({
  method:'POST',
  url:'http://server-employportal.1d35.starter-us-east-1.openshiftapps.com/updateEmployee',
